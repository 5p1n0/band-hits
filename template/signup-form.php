            ...
            <form class="text-center border border-light p-5" action="./login.php" method="post">
                ...
                <div  class="form-row mb-4">
                    <div class="col">
                        ...
                        <input id="nm" type="text" name="nome" class="form-control" placeholder="Enter your name" maxlength="29">
                    </div>
                    <div class="col">
                        <!-- Last name -->
                        <label for="cogn">Surname</label>
                        <input id="cogn" type="text" name="cognome" class="form-control" placeholder="Enter your surname" maxlength="29">
                    </div>
                </div>

                <!-- E-mail -->
                <label for="inputAddress">Email Address</label>
                <input type="email" id="Email" name="email" class="form-control mb-4" placeholder="E.g Mario.Rossi@unibo.it">

                <!-- Password -->
                <label for="pswd">Password</label>
                <input type="password"id="pswd" name="pass" class="form-control mb-4" placeholder="Enter a password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
                <!--Password-->

                <div class="form-group">
                    <label for="inputAddress">Address</label>
                    <input type="text" class="form-control" name="address" placeholder="Enter your residential address" maxlength="29">
                </div>

                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">City</label>
                        <input type="text" class="form-control" placeholder="E.g. Bolzano" name="city" maxlength="29">
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" name="zip" placeholder="E.g. 10435" minlength="5" maxlength="5">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="ccnumber" placeholder="Enter your credit card number" minlength="11" maxlength="16" pattern="[0-9]{11,16}">
                        
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="cc-expiration">Expiration date</label>
                        <input type="text" class="form-control" name="ccexp" placeholder="mm/aa">
                        
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="cc-ccv">CVV</label>
                        <input type="text" class="form-control" name="cccvv" placeholder="Enter your cvv" minlength="3" maxlength="3">
